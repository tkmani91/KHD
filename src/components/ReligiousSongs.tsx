            ...
            {featured.map(song => (
              ...
              >
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <button className="flex-1 bg-white text-gray-800 font-bold py-2.5 rounded-xl font-hind text-sm hover:bg-yellow-100 transition-colors flex items-center justify-center gap-2">
                    ⬇️ ডাউনলোড
                  </button>
                </div>
                {playingId === song.id && (
            ...
            >
              <div className="flex items-center gap-4 p-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button className="w-10 h-10 bg-orange-500/20 hover:bg-orange-500/40 rounded-xl flex items-center justify-center text-orange-300 transition-colors" title="ডাউনলোড">
                    ⬇️
                  </button>
                </div>
              </div>
