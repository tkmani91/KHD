...
const importantTimes = [
  ...
  { event: "ষষ্ঠীর বোধন", date: "১৭ অক্টোবর", time: "বিকাল ৫:১৫", note: "শুভ মুহূর্ত" },
  { event: "সপ্তমীর নবপত্রিকা", date: "১৮ অক্টোবর", time: "ভোর ৫:০০", note: "পুণ্য স্নান" },
  { event: "অষ্টমীর পুষ্পাঞ্জলি", date: "১৯ অক্টোবর", time: "সকাল ৯:৩০", note: "শুভ যোগ" },
  { event: "সন্ধিপূজা", date: "১৯ অক্টোবর", time: "রাত ১০:০০", note: "অষ্টমী-নবমী সন্ধি" },
  { event: "দশমীর বিসর্জন", date: "২১ অক্টোবর", time: "বিকাল ৩:০০", note: "বিজয়া শুরু" },
];
