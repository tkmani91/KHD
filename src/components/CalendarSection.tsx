...
const importantTimes = [
  { event: "মহালয়া", date: "২২ সেপ্টেম্বর ২০২৫", time: "ভোর ৪:৩০", note: "দেবীপক্ষ শুরু" },
  { event: "ষষ্ঠীর বোধন", date: "১ অক্টোবর", time: "বিকাল ৫:১৫", note: "শুভ মুহূর্ত" },
  { event: "সপ্তমীর নবপত্রিকা", date: "২ অক্টোবর", time: "ভোর ৫:০০", note: "পুণ্য স্নান" },
  { event: "অষ্টমীর পুষ্পাঞ্জলি", date: "৩ অক্টোবর", time: "সকাল ৯:৩০", note: "শুভ যোগ" },
  { event: "সন্ধিপূজা", date: "৩ অক্টোবর", time: "রাত ১২:০০", note: "অষ্টমী-নবমী সন্ধি" },
  { event: "দশমীর বিসর্জন", date: "৫ অক্টোবর", time: "বিকাল ৩:০০", note: "বিজয়া শুরু" },
];
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <h2 className="font-bengali text-3xl md:text-4xl font-bold text-red-800 mb-3">
            দুর্গাপূজা ২০২৫ — তিথি ও ক্যালেন্ডার
          </h2>
