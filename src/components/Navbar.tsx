...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Header Banner */}
      <div className="animated-gradient py-5 px-4 text-center text-white">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              ...
              <p className="font-hind text-xs text-orange-100 tracking-wide">
                Durgapuja12.blogspot.com — পূজা, ধর্ম ও সংস্কৃতির আলোকে
              </p>
      ...
      <nav className="bg-white shadow-md sticky top-0 z-50 border-b-4 border-orange-500">
          ...
          <div className="hidden lg:flex items-center">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="px-4 py-4 text-sm font-medium text-gray-700 hover:bg-orange-500 hover:text-white transition-all font-hind border-r border-gray-100 first:border-l"
              >
                {link.label}
              </a>
            ))}
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="lg:hidden bg-white border-t border-orange-100 px-4 py-3">
            <div className="flex flex-col gap-1">
              {navLinks.map((link) => (
                <a
                  ...
                  className="px-4 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-orange-50 hover:text-orange-700 transition-all font-hind"
                >
                  {link.label}
                </a>
              ))}
