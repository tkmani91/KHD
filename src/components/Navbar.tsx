...
const navLinks = [
  { label: "_হোম_", href: "#home", icon: "🏠" },
  { label: "_দুর্গাপূজা_", href: "#mahatmya", icon: "🛕", subtitle: "শারদীয় উৎসব" },
  { label: "_শ্যামাপূজা_", href: "#shyama", icon: "🌑", subtitle: "কালীপূজা" },
  { label: "_সরস্বতী পূজা_", href: "#saraswati", icon: "🎵", subtitle: "বিদ্যার দেবী" },
  { label: "_ফটো গ্যালারি_", href: "#gallery", icon: "📷", subtitle: "প্রতি বছরের ছবি" },
  { label: "_ধর্মীয় গান_", href: "#songs", icon: "🎶" },
  { label: "_PDF ফর্দ_", href: "#pdf", icon: "📥" },
  { label: "_যোগাযোগ_", href: "#contact", icon: "📞" },
];
