...
// ============================================================
const PUJA_DATE = "2025-10-01T05:00:00"; // মহাষষ্ঠী ২০২৫
    ...
    <section id="countdown" className="py-12 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="font-bengali text-3xl md:text-5xl font-black text-white mb-3">
            {isPujaTime ? (
              ...
              <>দুর্গাপূজা <span className="text-yellow-300">২০২৫</span> আসতে বাকি</>
            )}
          </h2>
          <p className="font-hind text-base text-orange-200">
            মহাষষ্ঠী: ১ অক্টোবর ২০২৫ — বিজয়াদশমী: ৫ অক্টোবর ২০২৫
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 max-w-4xl mx-auto">
          {[
            { day: "ষষ্ঠী", date: "১ অক্টো", emoji: "🌸", desc: "বোধন" },
            { day: "সপ্তমী", date: "২ অক্টো", emoji: "🌿", desc: "কলাবউ" },
            { day: "অষ্টমী", date: "৩ অক্টো", emoji: "🪔", desc: "সন্ধিপূজা" },
            { day: "নবমী", date: "৪ অক্টো", emoji: "🥁", desc: "মহাভোগ" },
            { day: "দশমী", date: "৫ অক্টো", emoji: "💧", desc: "বিসর্জন" },
          ].map((item, idx) => (
            <div
              key={item.day}
